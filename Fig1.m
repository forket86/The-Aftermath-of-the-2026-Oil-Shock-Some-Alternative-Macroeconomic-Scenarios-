% PACKAGE NOTE: Run from the package root with licensed Haver cbd.data access.
% PACKAGE NOTE: Insert your own FRED API key in api_key below before running.
% PACKAGE NOTE: Haver data extend through the current date, so reruns may differ.
