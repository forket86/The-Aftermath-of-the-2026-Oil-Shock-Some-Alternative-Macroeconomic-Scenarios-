% PACKAGE NOTE: Run from the package root with authorized Bloomberg raw CSV/XLSX files.
% PACKAGE NOTE: The legacy Haver addpath below is unused by this script.
% PACKAGE NOTE: Output directories are supplied in the package.
